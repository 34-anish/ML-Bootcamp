ML Community successfully conducted the phase I of machine learning (python, numpy , pandas , matplotlib). I really found the phase to be really helpful to me as well. 
